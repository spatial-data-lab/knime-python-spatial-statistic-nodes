...
@knext.node(name="Spatial Weights", node_type=knext.NodeType.MANIPULATOR, icon_path="../icons/icon.png", category=category.category)
...
# FIXME:
    ...
    Rows = knext.IntParameter("Rows", "Please choose your rows and colums of your lattice.", 5)
    Columns = knext.IntParameter("Columns", "Please choose your rows and colums of your lattice.", 5)
